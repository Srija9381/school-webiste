...
const numberOfImages = 11; // Change this to the number of images you have
const imageFolderPath = 'images/christmaspre/'; // Path to the folder containing the images

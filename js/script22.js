...
const numberOfImages = 5; // Change this to the number of images you have
const imageFolderPath = 'images/solosinging22/'; // Path to the folder containing the images

...
const numberOfImages = 6; // Change this to the number of images you have
const imageFolderPath = 'images/trafficawarness24/'; // Path to the folder containing the images

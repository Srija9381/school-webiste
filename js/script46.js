...
const numberOfImages = 51; // Change this to the number of images you have
const imageFolderPath = 'images/investiture24/'; // Path to the folder containing the images

...
const numberOfImages = 10; // Change this to the number of images you have
const imageFolderPath = 'images/teachersday22/'; // Path to the folder containing the images

...
const numberOfImages = 19; // Change this to the number of images you have
const imageFolderPath = 'images/feildtrips22/'; // Path to the folder containing the images

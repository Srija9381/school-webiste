...
const numberOfImages = 18; // Change this to the number of images you have
const imageFolderPath = 'images/nccselections24/'; // Path to the folder containing the images

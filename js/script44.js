...
const numberOfImages = 21; // Change this to the number of images you have
const imageFolderPath = 'images/blockopening22/'; // Path to the folder containing the images

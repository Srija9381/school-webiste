...
const numberOfImages = 12; // Change this to the number of images you have
const imageFolderPath = 'images/competition22/'; // Path to the folder containing the images

...
const numberOfImages = 31; // Change this to the number of images you have
const imageFolderPath = 'images/independance23/'; // Path to the folder containing the images

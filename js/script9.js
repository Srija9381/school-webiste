...
const numberOfImages = 4; // Change this to the number of images you have
const imageFolderPath = 'images/instrumental23/'; // Path to the folder containing the images

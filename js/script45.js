...
const numberOfImages = 91; // Change this to the number of images you have
const imageFolderPath = 'images/ugmemorial24/'; // Path to the folder containing the images

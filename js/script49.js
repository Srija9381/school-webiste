...
const numberOfImages = 17; // Change this to the number of images you have
const imageFolderPath = 'images/prepdollsbday24/'; // Path to the folder containing the images

...
const numberOfImages = 20; // Change this to the number of images you have
const imageFolderPath = 'images/vanmahotsav23/'; // Path to the folder containing the images

...
const numberOfImages = 8; // Change this to the number of images you have
const imageFolderPath = 'images/independance22/'; // Path to the folder containing the images

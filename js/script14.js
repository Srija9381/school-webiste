...
const numberOfImages = 35; // Change this to the number of images you have
const imageFolderPath = 'images/ugreddymemorial23/'; // Path to the folder containing the images
